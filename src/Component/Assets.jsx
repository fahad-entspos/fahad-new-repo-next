...
function Assets() {
  ...
  <div className='w-full h-full bg-[#F5F5F5] flex flex-wrap justify-around'>
...
<div className='bg-[#438FFE] w-[361px] h-[674px] flex flex-col rounded-2xl items-center ml-2 mt-4' >
